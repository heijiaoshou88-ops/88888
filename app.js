// ================= API 地址 =================
const API_URL = "https://2563d9d6c71b939966806cba1369dcc5.loophole.site/api/draw/prepare";
...
document.getElementById("start-btn").addEventListener("click", async () => {
  ...
  bannerText.className = data.data.font_style || "";
